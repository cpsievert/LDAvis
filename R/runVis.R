...
#' 
#' This function is a very small wrapper around \link{shiny::runApp}. Before 
#' calling this function, make sure you have four objects named 'phi', 
#' 'term.frequency', 'vocab', and 'topic.proportion' exist in the global 
#' environment and you also \link{check.inputs}.
#' 
...
#' z <- check.inputs(K=40, W=10473, phi=APdata$phi, 
#'                   term.frequency=APdata$term.frequency, vocab=APdata$vocab, 
#'                   topic.proportion=APdata$topic.proportion)
#'                  
#' # Assign the six elements of z as variables in the global environment and
#' # remove their list versions:
